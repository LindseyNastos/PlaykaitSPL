    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillNames", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CabinBills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CabinBills_BillNames_BillNameId",
                        column: x => x.BillNameId,
                        principalTable: "BillNames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CabinBills_Months_MonthId",
                        column: x => x.MonthId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CabinExpenses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CabinExpenses_ExpenseTypes_ExpenseTypeId",
                        column: x => x.ExpenseTypeId,
                        principalTable: "ExpenseTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CabinExpenses_Months_MonthId",
                        column: x => x.MonthId,
                        principalTable: "Months",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CabinBills_BillNameId",
                table: "CabinBills",
                column: "BillNameId");

            migrationBuilder.CreateIndex(
                name: "IX_CabinBills_MonthId",
                table: "CabinBills",
                column: "MonthId");

            migrationBuilder.CreateIndex(
                name: "IX_CabinExpenses_ExpenseTypeId",
                table: "CabinExpenses",
                column: "ExpenseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CabinExpenses_MonthId",
                table: "CabinExpenses",
                column: "MonthId");
        }
